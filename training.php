...
/**
 * Plugin Name:     Training by Pivotal
 * Plugin URI:      https://github.com/pvtl/wp-training.git
 * Description:     Adds a training custom post type, taxonomy and fields
...
class Training
{
    ...
    // The post type's slug eg. training
    protected $postType = 'training';

    // The taxonomies for this post type (assumes taxonomy name and file name as the same)
    protected $taxonomies = array('training-category');
